...
import pandas as pd
import sys
#This is the path where your get_faulty_mp3.py file sits
...
df_final = df_final.drop(['tid', 'index'], axis=1)

df_final = df_final.sort_values('path')

df_final.to_csv(os.path.join(path, 'pre_no_sound.csv'), index=False)
