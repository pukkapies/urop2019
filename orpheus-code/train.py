...
def train(train_dataset, valid_dataset, frontend, strategy, config, epochs, steps_per_epoch=None, timestamp_to_resume=None, update_freq=1, lr_range=None, analyse_trace=False):
    ...
    with strategy.scope():
       ...
       # set up logs and checkpoints directories
        ...
        for epoch in tf.range(prev_epoch+1, epochs, dtype=tf.int64):
            ...
            distributed_train_body(train_dataset, epoch, strategy.num_replicas_in_sync)
