''' Contains tools to fetch .mp3 files on our server, match 7digitalid's with tid's, and purge unwanted entries such as mismatches, faulty mp3 files, tracks without tags or duplicates.
